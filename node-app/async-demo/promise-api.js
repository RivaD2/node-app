...
//call .then to get result and display it on console
...
//I will say this one is for Facebook API for example:
...
- When they BOTH complete, I want to do something after.
...
/*
 ...
 - When I get result, the result is available as an array
...
/*
 ...
 - As soon as one promise is fulfilled from Promise.race()
    then the promise that is returned will be fulfilled
 - In this particular case, I would not get an array back, but one value
 */